...
<div class="ad small-width">ij pf ,eln
    <a href="#">
...
<article class="box chronicle-box side-chronicle">
                ...
                <ul class="chronicle-list">
                    <li>
                        <div class="photo">
                            ...
                            <img src="/images/img29.jpg" width="160" height="100" alt="image description">
                        </div>
                        <time class="time">21.12.13 @ Plau Club</time>
                        <p><strong><a href="#">SCSI9 на дне рождения...</a></strong></p>
                    </li>
                    <li>
                        <div class="photo">
                            <a href="#" class="btn-play"><i class="icon-right-dir"></i></a>
                            <img src="/images/img30.jpg" width="160" height="100" alt="image description">
                        </div>
                        <time class="time">22.12.13 @ Tresor Club</time>
                        <p><strong><a href="#">Steve Stoll: закрытии...</a></strong></p>
                    </li>
                    <li>
                        <div class="photo">
                            <a href="#" class="btn-play"><i class="icon-right-dir"></i></a>
                            <img src="/images/img31.jpg" width="160" height="100" alt="image description">
                        </div>
...
<article class="box poster-box slide-poster">
    <div class="photo">
        <a href="#">
            <img src="/images/img32.jpg" width="200" height="310" alt="image description">
        </a>
    </div>
    <div class="content">
